...
class FactScorer(object):
    ...
    def __init__(self,
                 model_name="just-extract-by-ChatGPT",
                 evaluated_model = "",
                 ...
                 batch_size=256):
        assert model_name in ["just-extract-by-ChatGPT", "just-extract-by-GPT-4", "just-extract-by-Gemini", "just-extract-by-mistral", "just-extract-by-llama-2"], model_name
