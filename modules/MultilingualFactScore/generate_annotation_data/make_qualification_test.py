...
- Question #0: Is the given biography relevant, irrelevant to the corresponding figure or an abstain generation?
    ...
    C. Abstain.      
"""
data_to_write = """--------------------Qualification test - Arabic--------------------
--------------------
--------------------
--------------------INTRODUCTION--------------------
...
json_arabic_path = f"~/FActScore/data/to_annotate_data/ar/task/{stage}/{language_model}_{annotator}_{sub_stage}_have_facts.jsonl"
...
file_path = f"~/FActScore/data/to_annotate_data/ar/task/{stage}/{sub_stage}/{annotator}/working_files/qualitifcation_test_Arabic_{language_model}_{annotator}_{sub_stage}.txt"
...
file_name = f"~/FActScore/data/to_annotate_data/ar/task/{stage}/{sub_stage}/{annotator}/working_files/answer_sheet_Arabic_{language_model}_{annotator}_{sub_stage}.csv"
...
data_to_write_csv = []
alphab = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "h", "y", "z"]
json_bengali_path = f"~/FActScore/data/to_annotate_data/bn/task/{stage}/{language_model}_{annotator}_{sub_stage}_have_facts.jsonl"
with open(json_bengali_path) as f:
    for i, line in tqdm(enumerate(f)):
        ...
        data_to_write_csv.append(["", "", "", "", "", ""])
# Specify the file path and mode ('w' for write)
file_path = f"~/FActScore/data/to_annotate_data/bn/task/{stage}/{sub_stage}/{annotator}/working_files/qualitifcation_test_Bengali_{language_model}_{annotator}_{sub_stage}.txt"
...
data_to_write = """--------------------Qualification test - Spanish--------------------
--------------------
--------------------
--------------------INTRODUCTION--------------------
- You will be given paragraphs of people's biographies generated by a language model (Gemini or GPT4), their internal sentences and facts embedded within each sentence. Make each fact factual validation based on Wikipedia. Please read the attached rule thoroughly before getting started.
...
1. SENTENCE: ...
	- 1.a. FACT: ...
            Question #1: Is the given fact properly broken-down from the original sentence? Refer to instructions within Step 2.4 of the provided rule.
                ...
                C. No. Need merge.
                D. No. Need edit (not aligned with the sentence).
            Question #2: If the given is not good (the answer is not "Yes"), provide your explanation (in English) and edit. 
                Answer:
            Question #3: Is the fact factually correct according to (supported by) Wikipedia? Refer to instructions within Step 2.1 and Tips of the provided rule.
                A. Supported.
                B. Not-supported.
...
json_spanish_path = f"~/FActScore/data/to_annotate_data/es/task/{stage}/{language_model}_{annotator}_{sub_stage}_have_facts.jsonl"
with open(json_spanish_path) as f:
    for i, line in tqdm(enumerate(f)):
        dp = json.loads(line)
        data_to_write_csv.append(["Figure: " + dp["topic"], "", "", "", "", ""])
        data_to_write_csv.append(["Biography quick review", "Answer of Question #0"])
...
file_path = f"~/FActScore/data/to_annotate_data/es/task/{stage}/{sub_stage}/{annotator}/working_files/qualitifcation_test_Spanish_{language_model}_{annotator}_{sub_stage}.txt"
...
# Print a message indicating that the data has been written
print(f"Data has been written to {file_path}.")
# file = f"~/FActScore/data/to_annotate_data/ar/task/{stage}/{sub_stage}/{annotator}/working_files/qualitifcation_test_Arabic_{language_model}_{annotator}_{sub_stage}"

file_name = f"~/FActScore/data/to_annotate_data/es/task/{stage}/{sub_stage}/{annotator}/working_files/answer_sheet_Spanish_{language_model}_{annotator}_{sub_stage}.csv"
